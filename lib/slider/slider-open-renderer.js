...
export default class SliderOpenRenderer {
    ...
    createLabels() {
        ...
        let labelValuesWithStep = this.getValuesWithStep(this.settings.customScale.min,
            this.settings.customScale.max, this.settings.customScale.step);
        this.values.forEach(value => {
            let label = this.createLabel(value.code, value.text);

            this.setLabelOffset(label, value.text, labelOffset);
            this.setLabelVisibility(label, value.text, labelValuesWithStep)
    ...
    setLabelVisibility(label, labelText, labelValuesWithStep) {
        if (!labelValuesWithStep.includes(labelText)) {
