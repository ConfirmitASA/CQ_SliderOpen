...
export default class SliderOpenRenderer {
    constructor(sliderId, container, sliderValues, sliderSettings) {
        this.id = sliderId;
    ...
    renderHorizontalImageSlider(sliderContainer, slider) {
        ...
        let endImage = document.createElement('div');
    ...
    applyHorizontalImageSliderStyles() {
        this.labelsNode.style.display = 'none';

        let endImage = this.sliderNode.querySelector('.cf-slider__end-image');
        let rightLabel = this.sliderContainerNode.querySelector('.cf-slider__label-right');
        let trackAreaNode = this.trackAreaNode;
        let handleNode = this.handleNode;
        let handleNoValueNode = this.handleNoValueNode;
        ...
        let themeColor = window.getComputedStyle(document.querySelector('.cf-navigation-next')).getPropertyValue('background-color');
