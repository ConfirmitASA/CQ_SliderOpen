...
class SliderOpenQuestionView extends QuestionWithAnswersView {
	...
	render() {
		...
		sliderContainer.innerHTML = '<div class="cf-single-slider-question cf-single-slider-question--custom ' + questionDirection + '">' + labelsContainer.outerHTML +
	...
	createLabelsContainer() {
		...
		if (this.sliderSettings.isVertical) {
			labelsContainer.style.height = (valuesWithStep.length * 3).toString() + 'em';
		}
